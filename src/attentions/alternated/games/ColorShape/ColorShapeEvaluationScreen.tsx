// src/attentions/alternated/games/ColorShape/ColorShapeEvaluationScreen.tsx
...
export function ColorShapeEvaluationScreen({ geminiReport, loaded, onRepeat, onBackToStart }: Props) {
  return (
