...
export function ColorShapeReportPanel(props: any) {
  ...
  const path = "src/attentions/alternated/games/ColorShape/ColorShapeReportPanel.tsx";
...
export default ColorShapeReportPanel;
