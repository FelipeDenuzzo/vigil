...
const s = {
  ...
  section: {
    ...
    borderRadius: 16, padding: 16, color: '#e8e9f0',
  } as const,
...
function EvaluationBlock({
  ...
  if (geminiReport)            return <InsetosReportPanel report={geminiReport} />;
    ...
    <section style={s.section}>
      <div style={s.errorBox}>
        ...
        <p style={{ fontSize: 12, color: '#a0a4be' }}>
          O serviço de IA não respondeu a tempo. O relatório será exibido na próxima consulta a esta sessão.
        </p>
      </div>
    </section>
  );
...
export function InsetosResult({ geminiReport, loaded, onRepeat, onBackToStart }: Props) {
  return (
