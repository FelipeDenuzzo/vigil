...
export function InsetosReportPanel(props: any) {
  ...
  const path = "src/attentions/alternating/games/Insetos/InsetosReportPanel.tsx";
...
export default InsetosReportPanel;
