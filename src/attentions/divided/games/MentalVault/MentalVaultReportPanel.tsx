...
export function MentalVaultReportPanel(props: any) {
  ...
  const path = "src/attentions/divided/games/MentalVault/MentalVaultReportPanel.tsx";
...
export default MentalVaultReportPanel;
