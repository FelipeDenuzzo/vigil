...
export function SelectiveListeningReportPanel(props: any) {
  ...
  const path = "src/attentions/divided/games/SelectiveListening/SelectiveListeningReportPanel.tsx";
...
export default SelectiveListeningReportPanel;
