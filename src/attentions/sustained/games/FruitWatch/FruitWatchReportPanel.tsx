...
export function FruitWatchReportPanel(props: any) {
  ...
  const path = "src/attentions/sustained/games/FruitWatch/FruitWatchReportPanel.tsx";
...
export default FruitWatchReportPanel;
