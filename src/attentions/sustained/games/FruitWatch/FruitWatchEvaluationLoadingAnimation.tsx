// src/attentions/sustained/games/FruitWatch/FruitWatchEvaluationLoadingAnimation.tsx

import { useEffect, useState } from 'react';

const MESSAGES = [
  { icon: '🥷', text: 'Concentrando o foco...' },
  { icon: '🍍', text: 'Analisando respostas da contagem silenciosa...' },
  { icon: '🧠', text: 'Calculando índices de estabilidade do foco...' },
  { icon: '⚖️', text: 'Verificando o controle de impulsividade visual...' },
  { icon: '✨', text: 'Estruturando seu relatório de Atenção Sustentada...' },
];

const ORGANIZING_MESSAGES = [
  { icon: '📝', text: 'Organizando resultados...' },
  { icon: '🏁', text: 'Quase pronto!' },
];

export function FruitWatchEvaluationLoadingAnimation({
  phase,
}: {
