...
export function LongMazesReportPanel(props: any) {
  ...
  const path = "src/attentions/sustained/games/LongMazes/LongMazesReportPanel.tsx";
...
export default LongMazesReportPanel;
