// src/attentions/selective/games/VisualSearchHunt/EvaluationLoadingAnimation.tsx
    ...
    >
      ...
      <div
        style={{
          ...
          animation: 'vigilPulse 1.8s ease-in-out infinite',
        }}
      >
        {phase.icon}
      </div>
      ...
      <p
        ...
        style={{
          ...
          color: '#e8e9f0',
          marginBottom: 6,
          animation: 'vigilSlideUp 0.3s ease',
        }}
      >
        {phase.title}{dots}
      </p>
          ...
          >
            <span
              style={{
                ...
                height: 8,
                borderRadius: '50%',
                background: i === phaseIndex ? p.color : '#4a4d62',
                display: 'inline-block',
