...
export function AcharOFaltandoReportPanel(props: any) {
  ...
  const path = "src/attentions/selective/games/AcharOFaltando/AcharOFaltandoReportPanel.tsx";
...
export default AcharOFaltandoReportPanel;
