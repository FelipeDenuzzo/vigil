...
const perfectMetrics: MentalVaultSessionMetrics = {
  ...
  rodadasMistas: 3,
  nivelMaximo: 6,
  avgAbsoluteRecall: 5.0,
  avgAbsoluteRecallPuras: 5.0,
  avgAbsoluteRecallMistas: 5.0,
  tbrsCost: 0,
...
const highMetrics: MentalVaultSessionMetrics = {
  ...
  rodadasMistas: 3,
  nivelMaximo: 5,
  avgAbsoluteRecall: 4.2,
  avgAbsoluteRecallPuras: 4.6,
  avgAbsoluteRecallMistas: 3.8,
  tbrsCost: 0.8,
...
const lowMetrics: MentalVaultSessionMetrics = {
  ...
  rodadasMistas: 3,
  nivelMaximo: 3,
  avgAbsoluteRecall: 2.1,
  avgAbsoluteRecallPuras: 2.9,
  avgAbsoluteRecallMistas: 1.3,
  tbrsCost: 1.6,
